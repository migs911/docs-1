...
* `labeled` — если установлено в `true`, раздел становится визуальным заголовком для группы пунктов меню.

## Labeled-разделы {#labeled}

Для визуального группирования пунктов в меню можно использовать специальные заголовки. Чтобы сделать пункт меню заголовком, добавьте к нему атрибут `labeled: true`.
...
В этом примере "Общее описание" будет отображаться как заголовок для последующих пунктов меню. Такой подход помогает визуально структурировать навигацию, особенно в больших документах с множеством разделов.
